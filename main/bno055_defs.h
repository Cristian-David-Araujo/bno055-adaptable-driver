 ...
 * @brief File containing the definitions of the BNO055 registers
 * @version 0.1
 * @date 2024-11-25
 * 
...
/** \name BN0-055 Registers Address Definitions
 * \{
 */
...
#define BNO055_E_NULL_PTR                          ((signed char) - 127)
#define BNO055_OUT_OF_RANGE                        ((signed char) - 2)
#define BNO055_SUCCESS                             ((uint8_t)0)
#define BNO055_ERROR                               ((signed char) - 1)
...
/***************************************************/
/**\name    ACK UART RESPONSE                  */
/***************************************************/
#define BNO055_ACK_VALUE                    (0xEE)

/* Write and Write command response*/
